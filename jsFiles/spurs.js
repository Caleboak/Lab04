...
function expensive(){
    ...
    else if(theName=='tanguy' || theName=='ndombele' || theName=='tanguy ndombele'){
...
function keeper(){
    ...
    else if(theName=='hugo' || theName=='lioris' || theName=='hugo lioris'){
...
function coach(){
    ...
    else if(theName=='nuno' || theName=='espirito' || theName=='santo' || theName=='nuno espirito santo'){
