...
function expensive(){
    ...
    else if(theName=='paul' || theName=='pogba' || theName=='paul pogba'){
...
function keeper(){
    ...
    else if(theName=='de gea' || theName=='david' || theName=='david de gea'){
...
function coach(){
    ...
    else if(theName=='ole' || theName=='gunner' || theName=='sloksjaer' || theName=='ole gunner sloksjaer'){
