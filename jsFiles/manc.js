...
function expensive(){
    ...
    else if(theName=='kevin' || theName=='de bruyne' || theName=='kevin de bruyne'){
...
function keeper(){
    ...
    else if(theName=='ederson' || theName=='moraes' || theName=='ederson de moraes'){
...
function coach(){
    ...
    else if(theName=='pep' || theName=='guardiola' || theName=='pep guardiola'){
