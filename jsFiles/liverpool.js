...
function expensive(){
    ...
    else if(theName=='virgil' || theName=='dijk' || theName=='virgil van dijk'){
...
function keeper(){
    ...
    else if(theName=='allison' || theName=='becker' || theName=='allison becker'){
...
function coach(){
    ...
    else if(theName=='jurgen' || theName=='klopp' || theName=='jurgen klopp'){
